...
import ExportNameDialog from '../alert/ExportNameDialog';
import jsPDF from 'jspdf';
import html2canvas from 'html2canvas';

const TaskSummaryFilterReport = ({reportData}) => {
...
<div className='p-6 bg-white rounded-md shadow'>
        <h2 className="text-xl font-semibold mb-4">Task Summary Filter Report</h2>
              {/* Filters Section */}
...
export default TaskSummaryFilterReport